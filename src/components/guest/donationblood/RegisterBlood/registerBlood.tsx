            ...
            {currentStep === "health" ? (
              ...
              >
                <button
                  ...
                  className="mb-5 px-26 py-2 bg-red-500 text-white rounded"
                >
                  Tiếp tục đăng ký hiến máu
                </button>
                <FormHealth
                  formData={formData} 
                  setFormData={(status) =>
              ...
              >
                <button
                  ...
                  className="mb-5 px-25 py-2 bg-red-500 text-white rounded"
                >
                  Quay lại chỉnh sửa sức khỏe
                </button>
                <FormRegisterBlood
                  formData={formData}
