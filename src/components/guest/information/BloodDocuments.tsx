      ...
      <div className="flex-1 container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto text-center mb-10">
          ...
          <p className="text-gray-700 text-lg">
            Tổng hợp các kiến thức, hướng dẫn và thông tin hữu ích về máu, hiến
            máu và truyền máu.
          </p>
        </div>
        <div className=" w-full max-w-6xl mx-auto bg-white rounded-xl shadow p-8">
          ...
          <p className="text-gray-700 mb-6">
            Có 8 nhóm máu phổ biến dựa trên sự hiện diện của các kháng nguyên A,
            B và protein Rh trên bề mặt hồng cầu.
          </p>
          {/* Nhóm máu */}
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <div className="border rounded-lg p-4 text-center">
              ...
              <div className="text-gray-600 text-sm mb-2">
                Có kháng nguyên A trên bề mặt hồng cầu và kháng thể kháng B
                trong huyết tương.
              </div>
            ...
            <div className="border rounded-lg p-4 text-center">
              ...
              <div className="text-gray-600 text-sm mb-2">
                Có kháng nguyên B trên bề mặt hồng cầu và kháng thể kháng A
                trong huyết tương.
              </div>
              <div className="flex justify-center gap-2">
            ...
            <div className="border rounded-lg p-4 text-center">
              ...
              <div className="text-gray-600 text-sm mb-2">
                Có cả kháng nguyên A và B trên bề mặt hồng cầu và không có kháng
            ...
            <div className="border rounded-lg p-4 text-center">
              ...
              <div className="text-gray-600 text-sm mb-2">
                Không có kháng nguyên A hay B trên bề mặt hồng cầu, nhưng có cả
                kháng thể kháng A và B.
              </div>
              <div className="flex justify-center gap-2">
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 text-sm mb-2">
              ...
              <li>
                <b>Rh âm (Rh-):</b> Không có kháng nguyên Rh trên bề mặt hồng
                cầu.
              </li>
            </ul>
          </div>
          ...
          <div>
            <div className="font-bold text-gray-800 mb-2">
              Phân bố nhóm máu trên thế giới
            </div>
            ...
            <table className="w-full text-sm border border-gray-300 rounded overflow-hidden">
              ...
              <tbody>
                ...
                <tr>
                  <td className="border px-2 py-1">AB+</td>
                  <td className="border px-2 py-1">~10%</td>
                ...
                <tr>
                  <td className="border px-2 py-1">O-</td>
                  <td className="border px-2 py-1">~0.3%</td>
        ...
        <div className="w-full max-w-6xl mx-auto bg-white rounded-xl shadow p-8">
          <h2 className="text-xl font-bold mb-4 text-gray-800">
            Thành phần máu và công dụng
          </h2>
          <p className="text-gray-700 mb-6">
            Máu toàn phần có thể được tách thành nhiều thành phần khác nhau, mỗi
            thành phần đều có công dụng riêng trong điều trị.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="border rounded-lg p-6">
              ...
              <div className="text-gray-700 mb-2">
                Máu toàn phần chứa tất cả các thành phần của máu: hồng cầu, bạch
            ...
            <div className="border rounded-lg p-6">
              ...
              <div className="text-gray-700 mb-2">
                Hồng cầu là thành phần vận chuyển oxy từ phổi đến các mô và cơ
                quan trong cơ thể.
              </div>
              <div className="font-semibold mb-1">Công dụng:</div>
              <ul className="list-disc list-inside text-gray-700 text-sm">
            ...
            <div className="border rounded-lg p-6">
              ...
              <div className="text-gray-700 mb-2">
                Huyết tương là phần lỏng của máu, chứa nước, protein và các yếu
                tố đông máu.
              </div>
              <div className="font-semibold mb-1">Công dụng:</div>
              <ul className="list-disc list-inside text-gray-700 text-sm">
            ...
            <div className="border rounded-lg p-6">
              ...
              <div className="text-gray-700 mb-2">
                Tiểu cầu giúp máu đông lại khi có vết thương, ngăn ngừa chảy máu
                quá nhiều.
              </div>
              <div className="font-semibold mb-1">Công dụng:</div>
              <ul className="list-disc list-inside text-gray-700 text-sm">
